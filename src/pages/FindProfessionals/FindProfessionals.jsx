...
const FALLBACK_PROFESSIONALS = [
  ...
  },
  {
    ...
    first_name: 'James',
    last_name: "O'Brien",
    designation: 'Certified Public Accountant (CPA)',
    country: 'Ireland',
    specializations: ['International Tax', 'M&A Advisory', 'Audit & Assurance'],
    experience: 9,
    hourly_rate: 200,
    bio: 'Independent auditor assisting tech startups with cross-border M&A transitions, international tax treaty planning, and corporate filings across Europe.',
  },
  {
    id: 'f3',
    first_name: 'Fatima',
    last_name: 'Al-Hassan',
    designation: 'Tax Consultant & Advisor',
    country: 'United Arab Emirates',
    specializations: ['GST / VAT', 'Compliance & Legal', 'Company Incorporation'],
    experience: 7,
    hourly_rate: 120,
    bio: 'Expert in GCC VAT rules, offshore corporate setups, and regulatory compliance advisory for investors expanding to Dubai and Abu Dhabi.',
  },
  {
    id: 'f4',
    first_name: 'Sarah',
    last_name: 'Jenkins',
    designation: 'M&A and Valuation Specialist',
    country: 'United Kingdom',
    specializations: ['M&A Advisory', 'Business Valuation', 'Financial Planning'],
    experience: 15,
    hourly_rate: 250,
    bio: 'Providing comprehensive corporate finance strategy, private equity evaluations, and business valuation reports for medium to large enterprises across the UK.',
  },
  {
    id: 'f5',
    first_name: 'David',
    last_name: 'Lee',
    designation: 'Corporate Secretary & Compliance Expert',
    country: 'Singapore',
    specializations: ['Company Incorporation', 'Compliance & Legal', 'Audit & Assurance'],
    experience: 10,
    hourly_rate: 180,
    bio: 'Specialist in ASEAN market entry, corporate governance standards, and company formation. Trusted compliance manager for over 100 regional corporations.',
  },
  {
    id: 'f6',
    first_name: 'Marcus',
    last_name: 'Vance',
    designation: 'CPA & Personal Wealth Manager',
    country: 'United States',
    specializations: ['Financial Planning', 'Corporate Tax', 'Compliance & Legal'],
    experience: 8,
    hourly_rate: 160,
    bio: 'Assisting small business owners and high-net-worth individuals with strategic tax planning, asset management, and federal IRS compliance filings.',
  },
];
